#include "viper_mounter_helper.h"
#include <QFile>
#include <QTextStream>
#include <QProcess>
#include <QSet>
...
QString ViperMounterHelper::manuallyEnabledConfPath = "/etc/viper/tolitica/automount/manually_enabled.conf";

// Define the base path for device resolution by UUID
QString ViperMounterHelper::diskByUUIDPath = "/dev/disk/by-uuid/";
...
// ----------------------------------------------------------------------------------------------
QSet<QString> ViperMounterHelper::getManuallyEnabledPartitions() {
...
// ----------------------------------------------------------------------------------------------
QSet<QString> ViperMounterHelper::getMountedPartitions() {
...
// ----------------------------------------------------------------------------------------------
void ViperMounterHelper::enforceMounts() {
...
void ViperMounterHelper::enforceUnmounts() {
