...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'vmwareStatus'
        QtMocHelpers::SlotData<bool()>(35, 2, QMC::AccessPrivate, QMetaType::Bool),
        // Slot 'vmwareServiceStatus'
        QtMocHelpers::SlotData<bool()>(36, 2, QMC::AccessPrivate, QMetaType::Bool),
        // Slot 'addonsSetupConnections'
        QtMocHelpers::SlotData<void(QStackedWidget *, QPushButton *, QPushButton *, QPushButton *, QPushButton *, QPushButton *, QPushButton *, QCheckBox *, QCheckBox *)>(37, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 8, 9 }, { 0x80000000 | 10, 38 }, { 0x80000000 | 10, 39 }, { 0x80000000 | 10, 40 },
            { 0x80000000 | 10, 41 }, { 0x80000000 | 10, 42 }, { 0x80000000 | 10, 34 }, { 0x80000000 | 17, 43 },
            { 0x80000000 | 17, 44 },
        }}),
        // Slot 'terminalSetupConnections'
        QtMocHelpers::SlotData<void(QStackedWidget *, QPushButton *, QPushButton *, QPushButton *, QPushButton *, QComboBox *, QLabel *)>(45, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 8, 9 }, { 0x80000000 | 10, 46 }, { 0x80000000 | 10, 47 }, { 0x80000000 | 10, 48 },
            { 0x80000000 | 10, 49 }, { 0x80000000 | 50, 51 }, { 0x80000000 | 52, 53 },
        }}),
        // Slot 'disableTermTheme'
        QtMocHelpers::SlotData<void(QPushButton *)>(54, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 10, 48 },
        }}),
        // Slot 'checkTermThemingStatus'
        QtMocHelpers::SlotData<int()>(55, 2, QMC::AccessPrivate, QMetaType::Int),
        // Slot 'asciiLogoStatus'
        QtMocHelpers::SlotData<int()>(56, 2, QMC::AccessPrivate, QMetaType::Int),
        // Slot 'enableAsciiLogo'
        QtMocHelpers::SlotData<void()>(57, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'mountDrivesSetupConnections'
        QtMocHelpers::SlotData<void(QStackedWidget *, QToolButton *)>(58, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 8, 9 }, { 0x80000000 | 59, 60 },
        }}),
    };
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 21: { int _r = _t->checkTermThemingStatus();
            if (_a[0]) *reinterpret_cast<int*>(_a[0]) = std::move(_r); }  break;
        case 22: { int _r = _t->asciiLogoStatus();
            if (_a[0]) *reinterpret_cast<int*>(_a[0]) = std::move(_r); }  break;
        case 23: _t->enableAsciiLogo(); break;
        case 24: _t->mountDrivesSetupConnections((*reinterpret_cast<std::add_pointer_t<QStackedWidget*>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QToolButton*>>(_a[2]))); break;
        default: ;
        }
    }
