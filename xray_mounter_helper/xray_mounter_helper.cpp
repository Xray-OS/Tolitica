...
QString XrayMounterHelper::manuallyEnabledConfPath = "/etc/xray/tolitica/automount/manually_enabled.conf";

// Define the base path for device resolution by UUID
QString XrayMounterHelper::diskByUUIDPath = "/dev/disk/by-uuid/";
...
// ----------------------------------------------------------------------------------------------
QSet<QString> XrayMounterHelper::getManuallyEnabledPartitions() {
...
// ----------------------------------------------------------------------------------------------
QSet<QString> XrayMounterHelper::getMountedPartitions() {
...
// ----------------------------------------------------------------------------------------------
void XrayMounterHelper::enforceMounts() {
...
void XrayMounterHelper::enforceUnmounts() {
